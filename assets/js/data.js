...
window.IS2_DATA = {
  ...
  phd: [
    { photo: "images/teampic/Xiangxiang_Chen.jpg", name: "Xiangxiang Chen",
      ...
      edu: { en: ["B.E., Xi'an Jiaotong University",
    ...
    { photo: "images/teampic/maxiaolin.jpg", name: "Xiaolin Ma",
      ...
      edu: { en: ["B.E., Zhejiang University", "ASE 25 2nd author, CAC 25 1st author"],
    ...
    { photo: "images/teampic/jianan.jpg", name: "Jianan Ma",
      ...
      edu: { en: ["B.E., Hangzhou Dianzi University",
  ...
  ra: [
    { photo: "images/teampic/fusiyue.jpg", name: "Siyue Fu",
      ...
      edu: { en: ["B.Sc., Case Western Reserve University", "M.Sc., University of Sydney"],
  ...
  alumni: [
    ...
    { who: "Jialuo Chen", role: { en: "Co-supervised PhD 2020-2025 · visiting Oxford; S&P 22, TOSEM 22, ASE 24, ISSTA 24", zh: "联合培养博士 2020-2025 · 牛津大学访问；S&P 22、TOSEM 22、ASE 24、ISSTA 24" }, where: { en: "Ant Group", zh: "蚂蚁集团" } },
  ...
  tracks: [
    {
      ...
      lede: { en: "Formal guarantees for the foundational software that safety-critical systems run on.",
      ...
      highlights: [
        {
          ...
          intro: { en: "Uses large language models to automatically construct the formal models that protocol verification normally demands by hand, lowering the expertise barrier to machine-checked security-protocol analysis.",
        ...
        },
        {
          ...
          intro: { en: "An industry-scale deployment applying end-to-end formal verification to the decentralized-identity system inside the Alipay super app, protecting millions of real users.",
        ...
        },
        {
          ...
          intro: { en: "Extends refinement-based reasoning so that security properties are provably preserved as concurrent systems are refined down toward their implementations.",
        ...
        },
        {
          ...
          intro: { en: "Brings quantitative runtime monitoring to blockchain, detecting attacks against Ethereum transactions as they unfold rather than after the fact.",
    ...
    },
    {
      ...
      lede: { en: "Testing, verifying and repairing AI models and AI-enabled systems.",
      ...
      highlights: [
        {
          ...
          intro: { en: "A white-box technique that uses adversarial sampling to surface individual-discrimination defects in neural networks \u2014 a foundational result in fairness testing.",
        ...
        },
        {
          ...
          intro: { en: "Defines robustness-oriented test metrics and generation so that the tests you run measurably strengthen a model's robustness, not merely its accuracy.",
        ...
        },
        {
          ...
          intro: { en: "Repairs faulty neural networks by letting formal verification results guide the synthesis of the fix, so the patched network ships with provable guarantees.",
        ...
        },
        {
          ...
          intro: { en: "An automatic, adaptive test-generation framework that builds large-scale benchmarks for evaluating LLM safety \u2014 released with an open dataset and a public leaderboard.",
    ...
    },
    {
      ...
      lede: { en: "Understanding and defending the safety of LLMs, agents and embodied intelligence.",
      ...
      highlights: [
        {
          ...
          intro: { en: "A testing framework that fingerprints deep learning models to detect unauthorized copying, published at IEEE S&P \u2014 a top-tier security venue.",
        ...
        },
        {
          ...
          intro: { en: "Lets a participant in federated learning verify that the server truly removed \u2014 \u2018unlearned\u2019 \u2014 its data, turning data deletion into something checkable rather than promised.",
        ...
        },
        {
          ...
          intro: { en: "Reveals a new attack surface: backdoors that stay dormant in a full-precision model and activate only after quantization rounding \u2014 exposing real risks in on-device model deployment.",
        ...
        },
        {
          ...
          intro: { en: "Extends quantization backdoor attacks to large language models, showing the threat is practical at LLM scale and motivating defenses for quantized deployments.",
