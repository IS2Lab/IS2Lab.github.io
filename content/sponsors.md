<!-- SPONSORS shown on the Research page.
     Put logo files in images/sponsors/ . Leave url blank for no link. -->
...
- en: Huawei
  zh: 华为
  logo: images/sponsors/huawei.png
  url: https://www.huawei.com/
- en: Alibaba Group
  zh: 阿里巴巴集团
  logo: images/sponsors/alibaba.png
